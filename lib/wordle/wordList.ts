// Extended list of valid 5-letter words for validation
export const validWords = new Set([
  // Romantic words
  'HEART', 'LOVER', 'SWEET', 'BLISS', 'CHARM',
  'AMOUR', 'CRUSH', 'SWOON', 'HONEY', 'CUPID',
  'ANGEL', 'DREAM', 'ADORE', 'FLAME', 'ROSES',
  'BRIDE', 'DANCE', 'GRACE', 'SMILE',
  ...
  'AVOID', 'AWARD', 'AWARE', 'BADLY', 'BAKER',
  'BASIC', 'BEACH', 'BEAST', 'BELLY', 'BENCH',
  'BILLY', 'BIRTH', 'BLACK', 'BLADE', 'BLAME',
  'BLANK', 'BLAST', 'BLEED', 'BLEND', 'BLIND',
  'BLOCK', 'BLOOD', 'BOARD', 'BOOST', 'BOOTH',
  'BOUND', 'BRAIN', 'BRAND', 'BREAD', 'BREAK',
  'BREED', 'BRIEF', 'BRING', 'BROAD', 'BROKE',
  'BROWN', 'BUILD', 'BUYER', 'CABLE', 'CALIF',
  ...
  'CROWD', 'CROWN', 'CRUDE', 'CURVE', 'CYCLE',
  'DAILY', 'DANCE', 'DATED', 'DEALT', 'DEATH',
  'DEBUT', 'DELAY', 'DEPTH', 'DOING', 'DOUBT',
  'DOZEN', 'DRAFT', 'DRAMA', 'DRANK', 'DRAWN',
